  ...
  return (
    ...
    >
      <Card variants={slideUp}>
        ...
        <ResultCard 
          variants={slideUp}
          style={{ borderLeftColor: getReturnColor(result.xirr) }}
        >
          <ResultRow>
            <ResultLabel>
            ...
            <HighlightValue style={{ color: getReturnColor(result.xirr) }}>
          ...
          <Button
            onClick={() => {
              const yearwiseBreakdown = document.getElementById('yearwise-breakdown');
              if (yearwiseBreakdown) {
                yearwiseBreakdown.scrollIntoView({ behavior: 'smooth' });
        ...
        >
          <ResultCard variants={slideUp}>
            <ResultRow>
              <ResultLabel>IRR (Internal Rate of Return)</ResultLabel>
              <ResultValue>{safeFormatPercentage(result.irr)}</ResultValue>
            </ResultRow>
            <InfoText>
          ...
          <ResultCard variants={slideUp}>
            <ResultRow>
              <ResultLabel>CAGR (Compound Annual Growth Rate)</ResultLabel>
              <ResultValue>{safeFormatPercentage(result.cagr)}</ResultValue>
            </ResultRow>
            <InfoText>
        ...
        <ResultCard variants={slideUp}>
          ...
          >
            <div>
              <ResultRow>
                <ResultLabel>Total Invested</ResultLabel>
                <ResultValue>{formatCurrency(result.totalInvested)}</ResultValue>
              </ResultRow>
              
              <ResultRow>
                <ResultLabel>Total Returns</ResultLabel>
                <ResultValue>{formatCurrency(result.totalReturns)}</ResultValue>
              </ResultRow>
            </div>
            
            <div>
              <ResultRow>
                <ResultLabel>Net Profit</ResultLabel>
                <ResultValue style={{ 
              ...
              <ResultRow>
                <ResultLabel>Absolute Return</ResultLabel>
                <ResultValue style={{ 
                  color: result.netProfit >= 0 ? colors.success.main : colors.error.main 
                }}>
